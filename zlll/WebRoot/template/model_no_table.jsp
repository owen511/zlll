...
<div id="div_all" layout="{w:{fit:true,min:800},h:{fit:'auto',min:350}}" style="position:relative;background-color:#fff; overflow:hidden;width:<%=clientWidth%>px;height:<%=bottomHeight%>px;">
    <div id="left_tree" layout="{h:{fit:true}}" style="display:block;  overflow-y:scroll;height:<%=bottomHeight%>px">
