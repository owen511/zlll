...
<div id="div_all" layout="{w:{fit:true,min:800},h:{fit:'auto',min:450}}" style="position:relative;background-color:#fff; overflow:hidden;width:<%=clientWidth%>px;height:<%=bottomHeight%>px;">
    <div id="left_tree" layout="{h:{fit:-1}}" style="display:block;  overflow-y:scroll;height:<%=bottomHeight%>px">
    ...
    <div id="main" layout="{h:{fit:true},w:{fit:'auto'}}" style="height:<%=bottomHeight%>px;">
		  <div id="tree_inner" oncontextmenu="return false;"></div>    
		  <tiles:insert attribute="navigation" />
		  <div id ="context" layout="{w:{fit:true},h:{fit:'auto',min:200,overflow:'scroll'}}" style="overflow-x:hidden;width:<%=mainWidth%>px;height:<%=bottomHeight%>px;">
