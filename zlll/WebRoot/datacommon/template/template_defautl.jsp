...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/calendarProject.js"></script>
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/ltext/datatabletheme.css" />
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/ltext/datatabletheme35.css" />
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/style/<%=gov.mof.fasp.ifmis.common.Globals.IFMIS_SKIN%>_style.css?t=<%=modifytime%>" />
		<link rel="stylesheet" id="ifmisfontstyle" type="text/css"
			href="<%=basePath%>/style/<%=styleName%>?t=<%=modifytime%>" />
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/style/<%=gov.mof.fasp.ifmis.common.Globals.IFMIS_LOGO%>_logo.css?t=<%=modifytime%>" />
		<link type="text/css" rel="stylesheet"
			href="<%=basePath%>/style/jquery.autocomplete.css?t=<%=modifytime%>" />
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/ltext/calendar/calendar.css?t=<%=modifytime%>" />
		<script type="text/javascript"
			src="<%=basePath%>/ltext/frameworksupport.js?t=<%=modifytime%>"></script>
		<script type="text/javascript"
			src="<%=basePath%>/js/jquery-1[1].3.1.js?t=<%=modifytime%>"></script>
		<script type="text/javascript"
			src="<%=basePath%>/js/jquery.md5.js?t=<%=modifytime%>"></script>
		<script type="text/javascript"
			src="<%=basePath%>/js/jquery.editable-select.js?t=<%=modifytime%>"></script>
		<script type="text/javascript"
		...
		<script type="text/javascript"
			src="<%=basePath%>/ltext/FusionCharts.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/ltext/calendar/calendar.js?t=<%=modifytime%>"></script>
		<script type="text/javascript" src="<%=basePath%>/ltext/ltext_core.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/js/changescroll.js?t=<%=modifytime%>"></script>
		<script type="text/javascript"
			src="<%=basePath%>/ltext/ltext_template.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/js/template.js?t=<%=modifytime%>"></script>
		<script type="text/javascript"
			src="<%=basePath%>/ltext/datatable3.0.js"></script>
		<script type="text/javascript" src="<%=basePath%>/ltext/editpanel.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/ltext/editdatatable.js"></script>
		<script type="text/javascript" src="<%=basePath%>/ltext/formulas.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/ltext/formulasdatatable.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/ltext/componentview/ltext_fileupload.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/ltext/swfupload/jslib/fupload.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/ltext/extends/fasp/ui.js"></script>
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>ltext\swfupload\css\default.css" />


		<!-- 采集表公用的js css -->
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/hashmap.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/jquery-1.8.3.min.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/json.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/datacommon.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/verifyutil.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/jumpto.js"></script>

		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/div.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/StringTokenizer.js"></script>

		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/extendDatatableType.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/extendInitTable.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/datatable/extendBaseTable.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/datatable/extendDataTable.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/tableview.js"></script>
				<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/dialog.js"></script>
		<!--
		这个js和框架有冲突，先引这个在引框架 
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/calendarProject.js?t=<%=modifytime%>"></script>
 		-->
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/extendInitProject.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/dataaudit.js"></script>
		<script type="text/javascript"
			src="<%=basePath%>/datacommon/common/js/extendTaskStatus.js"></script>
		
		<!-- CSS -->
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/datacommon/common/style/datacommon.css" />
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/datacommon/common/style/tableview.css" />
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/datacommon/common/style/global.css" />
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/datacommon/common/style/form.css" />
		<link rel="stylesheet" type="text/css"	
			href="<%=basePath%>/datacommon/common/style/dialog.css" />
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/datacommon/common/style/audit.css" />
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>/datacommon/common/style/pager.css" />
