...
<jsp:directive.page
	import="com.longtu.rpt.fm.rpt.rptmanager.dto.LtReportDTO" />
...
<%
	LtReportDTO reportDTO = (LtReportDTO)request.getAttribute("reportDTO");
...
<script type="text/javascript">
    ...
    function saveExit(){     
      ...
      formObject.action = '/ltrptapp/manage/reportedit_update.do?engine='+<%=engine%>;	
      formObject.submit(); 
    }
    function cancel(){
        var formObject = $("rptform");
		...
		<tr>
			...
			<td width='40%' valign='top'>
				<div id="sub_tree"
					...
					String mainmenu = "";
					String submenu = "";
					LtReportTypeDTO superid = (LtReportTypeDTO)request.getAttribute("superid");
					...
					if(null != viewLists)
					{
						...
						//String treeUrl = "/ltrptapp/manage/update_reportedit.do?mainmenu="+mainmenu+"&submenu="+submenu+"&reportid="+reportid;
						//String treeUrl = "javascript:setRptType(d)";
						String treeUrl = "javascript:;";
			...
			<td width='60%' valign='top'>
				<div
					...
					<form action="/ltrptapp/manage/reportedit_update.do" name='rptform' method="post">
						...
						<div id="form_table">
							<table border="0" cellpadding="0px" cellspacing="0px" style="width:100%">
							    <tr>
									...
									<th nowrap="nowrap">
										报表类别<span style="color:#FF0000;">&nbsp;*</span>
									</th>
								...
								<tr>
									...
									<td nowrap="nowrap">
										<select name=ispublic id=ispublic>
											<c:choose>
												<c:when test="${reportDTO.ispublic == 1}">
													<option value="0" >
														否
													</option>
									...
									<td nowrap="nowrap">
										<select name=showmenu id=showmenu>
											<c:choose>
												<c:when test="${reportDTO.showmenu == 1}">
													<option value="0" >
														否
													</option>
													<option value="1" selected="selected">
