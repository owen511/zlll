...
// Node object
function dNode(id, pid, name, url, data, title, target, icon, iconOpen, open) {
	this.id = id;
	this.pid = pid;
	this.name = name;
	this.url = url;
...
// Tree object
function dTree(objName,sImgPath,action) {
	this.config = {
		target					: null,
		folderLinks			: true,
		useSelection		: true,
...
dTree.prototype.add = function(id, pid, name, url, data,  title, target, icon, iconOpen, open,obj) {
	this.aNodes[this.aNodes.length] = new dNode(id, pid, name, url, data, title, target, icon, iconOpen, open,obj);
};
...
dTree.prototype.s = function(id) {
	...
	var cn = this.aNodes[id];	if( cn.data != null && this.onclick != null){			var func = this.onclick;			func(cn.data);	}
