...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #6D8496 1px solid;BORDER-TOP: #6D8496 1px solid;BORDER-LEFT: #6D8496 1px solid;';
strFrame+='BORDER-BOTTOM: #6D8496 1px solid;BACKGROUND-COLOR: #fff8ec;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#6D8496 bgcolor=#6D8496 Author="wayx">';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#6D8496 style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='        onclick="parent.meizzPrevM()" title="向前翻 1 月" Author=meizz><b Author=meizz><</b>';
strFrame+='        </td><td width=60 align=center style="font-size:12px;cursor:default" Author=meizz ';
strFrame+='onmouseover="style.backgroundColor=\'#6D8496\'" onmouseout="style.backgroundColor=\'white\'" ';
...
strFrame+='        <td width=16 bgcolor=#6D8496 align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=#6D8496 ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+=' BORDERCOLORLIGHT=#6D8496 BORDERCOLORDARK=#FFFFFF width=140 height=20 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#6D8496 BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 Author="wayx">';
...
function meizzSetDay(yy,mm)   //主要的写程序**********
{
  ...
  if(i<firstday)  //上个月的部分
  {
   ...
   else
   {
    ...
    meizzWDay[i]==outDate.getDate())? "#FF7E00" :
  ...
  else  //本月的部分
  {
   ...
   else
   {
    da.style.backgroundColor =(yy==outDate.getFullYear() && mm== outDate.getMonth() + 1 && meizzWDay[i]==outDate.getDate())?
     "#FF7E00":((yy == new Date().getFullYear() && mm == new Date().getMonth()+1 && meizzWDay[i] == new Date().getDate())?
     "#BBC7D0":"#e0e0e0");
    //将选中的日期显示为凹下去
