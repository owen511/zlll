  ...
  <ul>
	...
	<div id="form_table_title_edit" name="errortable" style="display:none;">
	  <ul>
	    ...
	    <li>
	      <input type="button" id="downbtn" class="button_style" style="width:50px;" onclick="download();" value="下载"/>
	    </li>
	  </ul>
	</div>
...
function checkDownFile() {
	var url = "/common/checkdownfile.do?errorfilename="+errorfilename;
	var flag = eval("("+JQ.ajax({type:"post",url: url,async: false}).responseText+")");
	return true;
}
//错误信息提示
