		...
		<div id="edit_table">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td nowrap="nowrap">
					...
					<td nowrap="nowrap">
					<input type="text" name=addcode id=addcode value="<%=request.getAttribute("code") %>" disabled = "disabled"/>
...
function saveExit(){
	...
	if(remark.length > 500){
    	...
    	formObject.action = "<%=request.getContextPath()%>/portal/caAdd/addsave.do?addcode="+addcode;
    	formObject.submit();
   }
}
