			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<th class = 'thwidth'><div align=left>标题<span>*</span></div></th>
      				<td nowrap=nowrap  colspan="1"  align="left"><input id="hyperlinkname" name="hyperlinkname" type=text class="text_popmin" title=""  />
      				<th class = 'thwidth'><div align=left>地址<span>*</span></div></th>
      				<td nowrap=nowrap  colspan="1"  align="left"><input id="linkurl" name="linkurl" type=text class="text_popmin" title=""  />
      				<th class = 'thwidth'><div align=left>顺序</div></th>
      				<td nowrap=nowrap  colspan="1"  align="left"><input id="linkorder" name="linkorder" type=text class="text_popmin" title=""  />
				</tr>
			</table>
...
function saveContinue(){
	if(checkInputValue()){
		var formObject = $("form1"); 
		formObject.action = "<%=request.getContextPath()%>/portal/hyperlink/addsave.do?savetype=1";
	 	formObject.submit();
 	}
}	 
//返回
