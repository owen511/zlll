...
[{"phone":"15011111111","user":"001003","failnumber":"1","content":"您有一条支付申请单据需要审核，谢谢！","smsid":"pay-001","system":"pay","createtime":"2012-07-12 10:38:50"},{"phone":"15011111112","user":"001004","failnumber":"1","content":"您有一条支付申请单据需要审核，谢谢！","smsid":"pay-002","system":"pay","createtime":"2012-07-13 10:38:50"}]
例2：
[{"msid":"indi-1"},{"msid":"indi-2"}]	 	</textarea>
  	 ...
  	 <tr><td></td><td colspan=2>
	     <input type="button" value="实时短信发送接口(返回失败的id)" onclick="a()">
	     <input type="button" value="短信保存接口" onclick="b()">
	     <input type="button" value="短信删除接口" onclick="c()">
	     <input type="button" value="短信查询接口" onclick="d()">
