...
<table width="16%" border="0" cellspacing="0" cellpadding="1" style="margin-top:40px; text-align:left; font-size:15px; margin-left:600">
  ...
  <tr style="height:73px;">
    ...
    <%}else{ %>
        ...
        <button id="login_button" onclick="doDataProcess()" style="height:30px; font-size:14px; width:80px; line-height:30px;"/>认证</button></td>
...
<p style="font-size:12px; color:#666666; text-align:center;">CopyRight 2009 厦门市财政局</p>
</div>
