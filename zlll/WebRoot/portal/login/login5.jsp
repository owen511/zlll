...
background-image:url(../../lightblue_images/login/20090930/body_bg.png);
...
height:768px;
width:100%;
background-image:url(../../lightblue_images/login/20091110/div_bg_three.jpg);
background-position:center center;
background-repeat:no-repeat;
}
.login_bg{
background-image:url(../../lightblue_images/login/20091110/login_bg.jpg);
background-position:center center;
background-repeat:no-repeat;
height:349px;
width:99%;
...
.login_btn{
border:0;
background-image:url(../../lightblue_images/login/20090930/login_btn_one.png);
background-position:center center;
background-repeat:no-repeat;
height:28px;
width:78px;
...
.reset_btn{
border:0;
background-image:url(../../lightblue_images/login/20090930/btn_one.png);
background-position:center center;
background-repeat:no-repeat;
height:28px;
width:78px;
...
height:200px;
width:360px;
background-image:url(../../lightblue_images/bg/gonggao_div.gif);
background-repeat:no-repeat;
background-position:left top;
font-size:12px;
/*left:10px;
...
top:0;
right:0; 
background-image:url(../../lightblue_images/login/20090930/download.gif); 
height:128px; 
width:128px; 
background-repeat:no-repeat; 
color:#FFF; 
...
<div class="div_bg">
   <div class="login_bg">
	    ...
	    <table width="480px" border="0" style="margin-top:220px; font-size:14px;">
	      ...
	      %>
	        <td nowrap="nowrap" align="left" width="50px" nowrap="nowrap">用户：</td>
...
<div class="download" onmouseover="this.className='download_over'" onmouseout="this.className='download'" ></div>
