...
background-image:url(../../ifmis_images/login/xiangtan/body_bg.png);
...
height:768px;
width:100%;
background-image:url(../../ifmis_images/login/xiangtan/xiangtan_bg.jpg);
background-position:center center;
background-repeat:no-repeat;
}
.login_bg{
background-image:url(../../ifmis_images/login/xiangtan/login_bg.jpg);
background-position:center center;
background-repeat:no-repeat;
height:349px;
width:99%;
...
.login_btn{
border:0;
background-image:url(../../ifmis_images/login/xiangtan/login_btn_one.png);
background-position:center center;
background-repeat:no-repeat;
height:28px;
width:78px;
...
.reset_btn{
border:0;
background-image:url(../../ifmis_images/login/xiangtan/btn_one.png);
background-position:center center;
background-repeat:no-repeat;
height:28px;
width:78px;
...
.gonggao_div table{ background:#FFF url(../ifmis_images/login/xiangtan/gonggao_bg.gif) repeat-x left top; }
.head_title{background:#FFF url(../ifmis_images/login/xiangtan/head_title.gif) no-repeat left top;width:40px;}
.head_end{ background:#FFF url(../ifmis_images/login/xiangtan/hand_end.gif) no-repeat right top;width:80px;}
.gonggao_div div{
font-size:12px;
height:25px;
line-height:25px;
...
top:0;
right:0; 
background-image:url(../../ifmis_images/login/xiangtan/download.gif); 
height:128px; 
width:128px; 
background-repeat:no-repeat; 
color:#FFF; 
...
<script language="JavaScript" type="text/javascript">
	window.status=" CopyRight 2011 湘潭市财政局";
	//国庆节
/*
function popmsg(){
var date=new Date();
...
<div class="div_bg">
   <div class="login_bg">
	    ...
	    <table width="480px" border="0" style="margin-top:165px;margin-left:40px; font-size:14px;">
	      ...
	      %>
	        <td nowrap="nowrap" align="left" width="50px" nowrap="nowrap">15用户：</td>
	      ...
	      <%if(Globals.isMultiDataSourceDeployMode()){ %>
	        ...
	        <select name="year">        
				<c:forEach var="loginyear"  items="${loginaCctyear}" >
				        <option value="<c:out value="${loginyear.all}"/>">湘潭<c:out value="${loginyear.acctmainbodyname}"/></option>
				</c:forEach>
	        </select>
	        </td>
  ...
  <p style="font-size:12px; color:#FFFFFF; text-align:right; width:480px; line-height:15px; height:15px;margin-top:49px;"> CopyRight 2011 湘潭市财政局</p>
 </div>
