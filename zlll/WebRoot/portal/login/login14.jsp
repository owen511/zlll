...
background-image:url(../../ifmis_images/login/zhangjiajie/body_bg.png);
...
height:768px;
width:100%;
background-image:url(../../ifmis_images/login/zhangjiajie/div_bg_three.jpg);
background-position:center center;
background-repeat:no-repeat;
}
.login_bg{
background-image:url(../../ifmis_images/login/zhangjiajie/login_bg.jpg);
background-position:center center;
background-repeat:no-repeat;
height:349px;
width:99%;
...
.login_btn{
border:0;
background-image:url(../../ifmis_images/login/zhangjiajie/login_btn_one.png);
background-position:center center;
background-repeat:no-repeat;
height:28px;
width:78px;
...
.login_button{
border:0;
background-image:url(../../ifmis_images/login/zhangjiajie/renzheng_one.png);
background-position:center center;
background-repeat:no-repeat;
height:28px;
width:78px;
...
.reset_btn{
border:0;
background-image:url(../../ifmis_images/login/zhangjiajie/btn_one.png);
background-position:center center;
background-repeat:no-repeat;
height:28px;
width:78px;
...
.gonggao_div table{ background:#FFF url(../ifmis_images/login/zhangjiajie/gonggao_bg.gif) repeat-x left top; }
.head_title{background:#FFF url(../ifmis_images/login/zhangjiajie/head_title.gif) no-repeat left top;width:40px;}
.head_end{ background:#FFF url(../ifmis_images/login/zhangjiajie/hand_end.gif) no-repeat right top;width:80px;}
.gonggao_div div{
font-size:12px;
height:25px;
line-height:25px;
...
top:0;
right:0; 
background-image:url(../../ifmis_images/login/zhangjiajie/download.gif); 
height:128px; 
width:128px; 
background-repeat:no-repeat; 
color:#FFF; 
...
<script language="JavaScript" type="text/javascript">
	window.status="Copyright (C) 2011 张家界市财政局";
	//国庆节
/*
function popmsg(){
var date=new Date();
	...
	<marquee direction=left scrollamount=2 scrolldelay=50 onmouseover="stop()" onmouseout="start()" style=" cursor:pointer; color:#000000;margin:20px 20px 0 10px;">
	 <% 
	         if(session.getAttribute("postList")!=null){
					...
					%>
					<img src="../ifmis_images/login/zhangjiajie/news.gif" />
...
<div class="div_bg">
   <div class="login_bg">
	    ...
	    <table width="480px" border="0" style="margin-top:172px;margin-left:40px; font-size:14px;">
	      ...
	      %>
	        <td nowrap="nowrap" align="left" width="50px" nowrap="nowrap">14用户：</td>
	        ...
	        <% }%>
	         ...
	         <td nowrap="nowrap" width="50px" align="left" nowrap="nowrap">年份：</td>
	      <%if(Globals.isMultiDataSourceDeployMode()){ %>
	        <td nowrap="nowrap" align="left" width="80px">
	        <select name="year">        
				<c:forEach var="loginyear"  items="${loginaCctyear}" >
				        <option value="<c:out value="${loginyear.all}"/>">张家界<c:out value="${loginyear.acctmainbodyname}"/></option>
				</c:forEach>
	        </select>
	        </td>
  ...
  <p style="font-size:12px; color:#FFFFFF; text-align:right; width:480px; line-height:15px; height:15px;margin-top:49px;">Copyright (C) 2011 张家界市财政局</p>
 </div>
