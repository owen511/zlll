...
.ca_style{width:211px; height:26px; background-image:url(../ifmis_images/festival/specialOne/ca_login.gif);background-position:top center; background-repeat:no-repeat; color:#FFF; text-align:left; line-height:26px; cursor:pointer;}
.nomal_style{width:211px; height:26px; background-image:url(../ifmis_images/festival/specialOne/nomal_login.gif);background-position:top center; background-repeat:no-repeat; color:#FFF; text-align:left; line-height:26px; cursor:pointer;}
</style>
...
<div class="div_bg">
   <div class="login_bg">
	    ...
	    <table id="ptdl"  width="469px" border="0" cellpadding="0" cellspacing="0" style="display:none; margin-top:199px; font-size:14px;">
	      <tr width="380px">
	      <!-- -请不要添加默认的用户和密码  -->
	        <td nowrap="nowrap" align="left" width="50px" nowrap="nowrap">c9用户：</td>
