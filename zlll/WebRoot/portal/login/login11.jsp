...
<script language="JavaScript" type="text/javascript">
	window.status="Copyright (C) 2011 郴州市财政局";
	//国庆节
/*
function popmsg(){
var date=new Date();
...
<div class="div_bg">
   <div class="login_bg">
	    ...
	    <table width="480px" border="0" style="margin-top:165px;margin-left:40px; font-size:14px;">
	      ...
	      %>
	        <td nowrap="nowrap" align="left" width="50px" nowrap="nowrap">11用户：</td>
  ...
  <p style="font-size:12px; color:#FFFFFF; text-align:right; width:480px; line-height:15px; height:15px;margin-top:49px;">Copyright (C) 2011 郴州市财政局</p>
 </div>
