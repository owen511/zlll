...
.div_bg {
	height: 768px;
	width: 100%;
	background-image: url(../ifmis_images/login/fujian/div_bg_three.jpg);
	background-position: center center;
	background-repeat: no-repeat;
}

.login_bg {
	background-image: url(../../ifmis_images/login/20091110/login_bg_fj.jpg);
	background-position: center center;
	background-repeat: no-repeat;
	height: 349px;
	width: 99%;
...
.login_btn {
	border: 0;
	background-image:
		url(../../ifmis_images/login/20090930/login_btn_one.png);
	background-position: center center;
	background-repeat: no-repeat;
	height: 28px;
	width: 78px;
...
.safe_btn {
	border: 0;
	background-image: url(../ifmis_images/login/fujian/safe_login.png);
	background-position: center center;
	background-repeat: no-repeat;
	height: 28px;
	width: 78px;
...
.ca_style {
	width: 211px;
	height: 26px;
	background-image: url(../images/login/choose_account_CA.gif);
...
.nomal_style {
	width: 211px;
	height: 26px;
	background-image: url(../images/login/choose_account_nomal.gif);
	background-position: top center;
	background-repeat: no-repeat;
	color: #FFF;
	text-align: left;
...
var mytime=setTimeout("popshow();",60);
 ...
 %> </a> (
		...
		<div class="div_bg">
			<div class="login_bg">
				<form id="form1" name="form1" autocomplete="off" method="post"
				...
				<form id="form2" name="form2" autocomplete="off" method="post"
					action="<%=request.getContextPath()%>/login.do">
