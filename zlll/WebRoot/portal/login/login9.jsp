...
.choose_acc{ color:#FFF; text-align:center; font-size:12px; font-weight:normal; width:105px; text-align:center; float:left;}

.download a:link{color:#FFF; text-deco}
.ca_style{width:211px; height:26px; background-image:url(../images/login/choose_account_CA.gif);background-position:top center; background-repeat:no-repeat; color:#FFF; text-align:left; line-height:26px; cursor:pointer;}
.nomal_style{width:211px; height:26px; background-image:url(../images/login/choose_account_nomal.gif);background-position:top center; background-repeat:no-repeat; color:#FFF; text-align:left; line-height:26px; cursor:pointer;}
</style>
...
<script language="JavaScript" type="text/javascript">
	window.status="Copyright (C) 2011 重庆财政局";
	//国庆节
/*
function popmsg(){
var date=new Date();
...
<div class="div_bg">
   <div class="login_bg">
	    ...
	    <table id="ptdl"  width="469px" border="0" cellpadding="0" cellspacing="0" style="display:none; margin-top:199px; font-size:14px;">
	      <tr width="380px">
	      <!-- -请不要添加默认的用户和密码  -->
	        <td nowrap="nowrap" align="left" width="50px" nowrap="nowrap">9用户：</td>
	      ...
	      <%if(Globals.isMultiDataSourceDeployMode()){ %>
	        ...
	        <select name="loginacctyear" style="width:80px;">        
	        ...
	        <td width="23%" nowrap="nowrap">
	        <select name="logingovid" style="width:80px;">        
	        ...
	        <tr style="height:34px;">
		        ...
		        <td colspan="5" nowrap="nowrap" valign="middle"><font color="red"><c:out value="${msg}"/></font></td>
	        </tr>
	        <tr>
	   ...
	   <form id="form2" name="form2" autocomplete="off" method="post" action="<%=request.getContextPath()%>/login.do">
	    <table id="cadl" width="469px" border="0" cellpadding="0" cellspacing="0" style="display:block;margin-top:217px; font-size:14px;">
	      <tr width="380px">
	      <!-- -请不要添加默认的用户和密码  -->
	         <td nowrap="nowrap"style="text-align:right;">年份：</td>
	      <%if(Globals.isMultiDataSourceDeployMode()){%>
	        ...
	        <td colspan="2" nowrap="nowrap" style="text-align:left;" width="45%" >
	        <input type="hidden" id="signed_data" name="signed_data"/>
	        <input type="button" class="renzheng_btn" id="login_button" onclick="doDataProcess()""/></td>
	        <%}else{%>
	        <td nowrap="nowrap" style="text-align:left;" width="25%">
	        <select name="loginacctyear" style="width:80px;">        
				<c:forEach var="loginacctyear"  items="${loginaCctyear}" >
	        ...
	        <td nowrap="nowrap"style="text-align:right;"><font color="#ffffff">财政：</font></td>
	        <td nowrap="nowrap" style="text-align:left;" width="25%">
	        <select name="logingovid" style="width:80px;">        
				<c:forEach var="logingovid"  items="${loginGovid}" >
				          <option value="<c:out value="${logingovid.govid}"/>"><c:out value="${logingovid.name}"/></option>
	      ...
	      <tr style="height:34px;">
	        <td colspan="4" nowrap="nowrap" valign="middle"><input type="hidden" name="screenwidth"><font color="red"><c:out value="${msg}"/></font></td>
	      </tr>
	      <tr>
	    ...
	    <table width="469px" border="0" cellpadding="0" cellspacing="0">
     	<tr style="height:10px;">
          ...
          <tr>
            <td nowrap="nowrap" align="center" colspan="7" valign="bottom" style="height:26px;"><div id="nomalandca" class="ca_style"><div class="choose_acc" onclick="jumpToCA()">CA认证</div><div class="choose_acc" onclick="jumpToNomal()" >普通用户</div></div></td>
          </tr>
	    </table>

 </div>
<p style="font-size:12px; color:#FFFFFF; text-align:right; width:480px; line-height:15px; height:15px;">Copyright (C) 2011 重庆财政局</p>
</div>
