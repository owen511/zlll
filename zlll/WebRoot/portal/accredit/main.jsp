...
String indexjsp = (String)session.getAttribute("isgsaccedit");
%>
...
function doAdd() {
    ...
    var url = "<%=request.getContextPath()%>/portal/accredit/turnToSave.do?mainmenu="+mainmenu+"&submenu="+ submenuid;
    var jsp = <%=indexjsp%>;
    if(0!=jsp){
    	url = "<%=request.getContextPath()%>/portal/accredit/gsturnToSave.do?mainmenu="+mainmenu+"&submenu="+ submenuid;
    }
...
function doMod(){
    ...
    var url = "<%=request.getContextPath()%>/portal/accredit/turnToModify.do?mainmenu="+mainmenu+"&submenu="+ submenuid + "&accreditid="+ accreditid;
    window.location.href = url;
}
...
function getBack()
{
    ...
    var url = "<%=request.getContextPath()%>/portal/accredit/getBack.do?mainmenu="+mainmenu+"&submenu="+ submenuid + accreditid;
...
function doDel(){
    ...
    var url = "<%=request.getContextPath()%>/portal/accredit/delete.do?mainmenu="+mainmenu+"&submenu="+ submenuid + accreditid;
...
function DisableF5(){   
	...
	var submenu= <%=request.getParameter("submenu") %>;
		window.location="<%=request.getContextPath() %>/portal/accredit/query.do?mainmenu="+mainmenu+"&submenu="+submenu;
		event.keyCode = 0;   
...
<form id="queryform" name="queryform" method="post"
	action="<%=request.getContextPath()%>/portal/accredit/query.do?mainmenu=<c:out value="${param.mainmenu}"/>&submenu=<c:out value="${param.submenu}"/>"
