...
<div>
<p align="right"><input name="submit3" type="button" value="返回" onclick="cancel()" /></p>
</div>
</div>
</div>  
...
<script>
//begin 楚艳红 2012.12.06 业务程序地址改为弹出框增加appcaller加载
function loadAppcaller(){
	Ext.lt.ifmis.activex.loadAppCallerOcx();
}
//end 楚艳红 2012.12.06 业务程序地址改为弹出框增加appcaller加载
