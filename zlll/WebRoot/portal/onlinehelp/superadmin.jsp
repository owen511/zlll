...
<html>
  ...
  <body>
    	...
    	<span style="border: #dae7f6 1px solid;"><span style="border: #dae7f6 1px solid;" title="加精置顶" style="float: left;height: 20px;background-image: url(/images/done_btn/state.gif);background-repeat: no-repeat;background-position: left;padding-left: 18px;padding-right: 5px;" onclick="settopquestion();" onmouseover="doChangBg(this)" onmouseout="doReturn(this)" onmousedown="doChangeBg1(this)"><a href="#">加精置顶</a></span><span style="border: #dae7f6 1px solid;">｜</span></span>
    	<span style="border: #dae7f6 1px solid;"><span style="border: #dae7f6 1px solid;" title="禁止开放" style="float: left;height: 20px;background-image: url(/images/done_btn/close.gif);background-repeat: no-repeat;background-position: left;padding-left: 18px;padding-right: 5px;" onclick="setpublicquestion();" onmouseover="doChangBg(this)" onmouseout="doReturn(this)" onmousedown="doChangeBg1(this)"><a href="#">禁止开放</a></span><span style="border: #dae7f6 1px solid;">｜</span></span>
	...
	var superadminTabPanel = new Ext.TabPanel({
		...
		var templatesuperAdmin =new Ext.Panel({
			...
			tbar:new Ext.Toolbar(['标题：',{xtype:'textfield',width:130,id:'textfieldnewquestionName'},'-',
									'问题类型：',questionType,'-',
									auditset==1?'问题地区:&nbsp&nbsp':'',questionArea
									])	
