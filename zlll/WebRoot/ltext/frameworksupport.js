...
Ext.UpdateManager.defaults.indicatorText = '<div class="loading-indicator">¼ÓÔØÖÐ...</div>';
...
if(Ext.grid.GridPanel){
   Ext.grid.GridPanel.prototype.ddText = "{0} Ñ¡ÔñÐÐ";
}
...
if(Ext.PagingToolbar){
   Ext.apply(Ext.PagingToolbar.prototype, {
      ...
      emptyMsg       : 'Ã»ÓÐÊý¾ÝÐèÒªÏÔÊ¾'
   });
}

if(Ext.form.TextField){
   Ext.apply(Ext.form.TextField.prototype, {
      minLengthText : "¸ÃÊäÈëÏîµÄ×îÐ¡³¤¶ÈÊÇ {0}",
...
if(Ext.form.NumberField){
   Ext.apply(Ext.form.NumberField.prototype, {
      minText : "¸ÃÊäÈëÏîµÄ×îÐ¡ÖµÊÇ {0}",
      maxText : "¸ÃÊäÈëÏîµÄ×î´óÖµÊÇ {0}",
      nanText : "{0} ²»ÊÇÓÐÐ§ÊýÖµ"
   });
}
...
if(Ext.form.DateField){
   Ext.apply(Ext.form.DateField.prototype, {
      ...
      minText           : "¸ÃÊäÈëÏîµÄÈÕÆÚ±ØÐëÔÚ {0} Ö®ºó",
      maxText           : "¸ÃÊäÈëÏîµÄÈÕÆÚ±ØÐëÔÚ {0} Ö®Ç°",
      invalidText       : "{0} ÊÇÎÞÐ§µÄÈÕÆÚ - ±ØÐë·ûºÏ¸ñÊ½£º {1}",
      format            : "yÄêmÔÂdÈÕ"
   });
}
...
if(Ext.form.VTypes){
   Ext.apply(Ext.form.VTypes, {
      emailText    : '¸ÃÊäÈëÏî±ØÐëÊÇµç×ÓÓÊ¼þµØÖ·£¬¸ñÊ½Èç£º "user@example.com"',
      urlText      : '¸ÃÊäÈëÏî±ØÐëÊÇURLµØÖ·£¬¸ñÊ½Èç£º "http:/'+'/www.example.com"',
      alphaText    : '¸ÃÊäÈëÏîÖ»ÄÜ°üº¬×Ö·ûºÍ_',
      alphanumText : '¸ÃÊäÈëÏîÖ»ÄÜ°üº¬×Ö·û,Êý×ÖºÍ_'
   });
}
...
if(Ext.layout.BorderLayout && Ext.layout.BorderLayout.SplitRegion){
   Ext.apply(Ext.layout.BorderLayout.SplitRegion.prototype, {
      ...
      collapsibleSplitTip : "ÍÏ¶¯À´¸Ä±ä³ß´ç. Ë«»÷Òþ²Ø."
   });
}
