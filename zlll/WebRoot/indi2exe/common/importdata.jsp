...
<div id="form_table_title_edit">
  <ul>
	...
	<script type="text/javascript">	
		...
		function addDetail(){
			var url = "<%=request.getContextPath()%>/indi/common/searchFile.do?vchtypeid="+<c:out value="${vchtypeid}"/> + '&submenu=' + <c:out value="${param.submenu}"/>+ '&mainmenu=' + <c:out value="${param.mainmenu}"/>;
		...
		function importData(formObject){
			if(checkData()){
				...
				formObject.action = "<%=request.getContextPath()%>/indi/common/importData.do?vchtypeid="+vchtypeid  + '&submenu=' + <c:out value="${param.submenu}"/>+ '&mainmenu=' + <c:out value="${param.mainmenu}"/>;
				formObject.submit();
			}
		}
