...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script>
			...
			queryform.action = "<%=request.getContextPath()%>/indi/common/queryimportdata1.do?mainmenu=<c:out value="${param.mainmenu}"/>&submenu=<c:out value="${param.submenu}"/>&vchtypeid=<c:out value="${param.vchtypeid}"/>&errorfilename="+errorfilename;	
			queryform.submit();
		</script>
	</head>
