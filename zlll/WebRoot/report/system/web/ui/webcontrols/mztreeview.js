...
MzTreeNode.prototype.render = function(last)
{
 ...
 var icon=s.getAttribute("icon");
  s += "<div><table "+(isRoot&&$.hiddenRoot?" style='display:none;'":"")+" border='0' cellpadding='0' cellspacing='0'>"+
  ...
  if(seq&&seq!=null){
	s += "<img border='0' src='"+System.path+"/system/_resource/mzmine/"+seq +".gif'>";
	s += "<img border='0' src='"+ 
       MzTreeView.icons.line["l6"].src +"'>"
  }
  s += "<img border='0' id='"+ $.index +"_icon_"+ id +"' src='"+ 
       MzTreeView.icons.collapse[this.icon].src +"'>"; if($.useCheckbox&&this.id.indexOf("A")==0)
