...
function saveExit(){
    ...
    formObject.action = ROOT_PATH+"/system/expressionrule/manage/modify/savereturn.do?mainmenu=<%=mainmenu%>&submenu=<%=submenu%>";
	formObject.submit();
}
...
function maindatasynchfromtable(rowObj){
	if(typeof(rowObj)=="object"){
		if(typeof(rowObj.itemid) !="undefined"){
			$("form1").itemid.value = rowObj.itemid;
		}
		if(typeof(rowObj.code) !="undefined"){
...
function maindatasynch(obj){
	try{
		...
		if( rowObj!=null && typeof(rowObj) == "object"){
			rowObj.itemid = $("form1").itemid.value;
...
<form name="form1" id="form1"
	action="<%=basePath%>/system/expressionrule/manage/modify/savereturn.do?mainmenu=<%=mainmenu%>&submenu=<%=submenu%>"
	method="post">
		...
		<table border="0" cellpadding="0px" cellspacing="0px">
			<tr>
				...
				<td nowrap="nowrap" width="20%">
					<input type="hidden" name=itemid id=itemid value="" onkeyup=";maindatasynch(this);"/>
	...
	<input name="json" id="json" value="" type="hidden">
