...
<input type="hidden" id="hid" value="<c:out value='${mainListSetDTO.colID}'/>"/>
<!-- 新的样式 -->
...
<table width="664" border="1" >
  ...
  <tr>
	...
	<td><input type="text" name="colName" size="20" style="width:60%;"  value="<c:out value='${mainListSetDTO.colName}'/>"/>    </td>
  </tr>
  <tr>
    <th width="69"><div align="left">显示次序</div></th>
    <td><input id="check" type="text" name="orderNum" size="10" style="width:60%;" value="<c:out value='${mainListSetDTO.orderNum}'/>" /></td>
  </tr>
  <tr>    
...
<div style="float:right;">
      ...
      <input type="button" name="exit" value="返回"  onclick="location.href='/system/ui/mainSetList.do?linkname=<c:out value='${linkname}'/>'" class="button_style" onmouseover="this.className='OverBtn'" onmouseout="this.className='button_style'" onmousedown="this.className='down'"/>
</div>
</body>
</html>
<script type="text/javascript">
  ...
  //弹出页面选择级联控制
	function onchangeshowconfig(value){
		var columncode = document.addMainSet.colId.value;
...
function saveAndGo(){
 ...
 if(checkNull()){
       ...
       var url = "/system/ui/addMainListSet.do";
