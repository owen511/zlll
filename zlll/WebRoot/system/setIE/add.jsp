...
function saveExit(){
    ...
    document.getElementById('site').value=document.getElementById('name').value;
	formObject.action = '<%=request.getContextPath()%>/system/moudeldef/saveSite.do';
	formObject.submit();
}
...
<form name="form1" id="form1"
	action="<%=request.getContextPath()%>/system/moudeldef/saveSite.do"
	method="post">
	...
	<div id="edit_table" >
		...
		<th nowrap="nowrap">
				...
				<td nowrap="nowrap">
					<input name=name type="text" id=name  onblur="checkIP(this);"/>
